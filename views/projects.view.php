                        ...
                        <div class="ps-content">
                            <ul class=" list-group list-group-flush">
                                ...
                                <?php if (isset($projects)) {	
                                    ...
                                    ?>                         
                                    <li class="accordion list-group-item pe-auto" id="project-p-<?php echo $i; ?>" draggable=true>        
                                                    ...
                                                    <div class="ps-content">
                                                        ...
                                                        <?php if (isset($show_tasks)) {	
                                                            ...
                                                            foreach ($show_tasks as $s): 
                                                                if($s['task_status'] == '1'){
                                                        ?>  
                                                            <li class="accordion list-group-item pe-auto" id="task-todo-<?php echo $i; ?>" draggable="true">                                                                      
                                            ...
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        ...
                                                        <li class="accordion list-group-item pe-auto" id="task-ip-<?php echo $i; ?>" draggable="true">        
                                                                <div class="todo-indicator" style="background-color:<?php echo $s['task_color'];?>;">
                                                                </div>
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                ...
                                                <div style="position: static;" class="ps ps--active-y">
                                                    <div class="ps-content">
                                                        ...
                                                        ?>  
                                                            ...
                                                            <li class="accordion list-group-item pe-auto" id="task-c-<?php echo $i; ?>" draggable="true">        
                                                                <div class="todo-indicator" style="background-color:<?php echo $s['task_color'];?>;">
                                                                </div>
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
